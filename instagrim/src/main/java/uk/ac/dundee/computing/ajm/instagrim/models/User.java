...
import uk.ac.dundee.computing.ajm.instagrim.lib.AeSimpleSHA1;
...
public class User {
    ...
    public boolean IsValidName(String username, String password, String email, String first_name, String last_name ){
